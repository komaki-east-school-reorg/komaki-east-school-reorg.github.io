...
- **大学自身の公表を事実の出所に使ってよいのは、その大学自身のことだけ**（2026-09-20）。愛知文教大学の募集停止は大学の公表（令和8年3月30日の臨時理事会）による。新聞報道はこのページでも根拠にしないので、誉高校の移転計画は `rev_o15` の「確認できなかったこと」に置いてある — 報道を根拠に本文へ書き足さないこと。
